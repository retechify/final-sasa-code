...
export default function Contact() {
  ...
  return (
    <main className="relative pt-32 pb-0 overflow-x-hidden">
      <SEO 
        title="Contact SASHA School | Coimbatore Primary School"
        description="Get in touch with SASHA School of Life in Kovaipudur, Coimbatore. Contact us for admissions, campus tours, and general inquiries."
        url="/contact"
      ...
      <section className="max-w-7xl mx-auto px-gutter pb-24 relative z-10 reveal">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            {/* WhatsApp */}
            <a href="https://wa.me/919750170007?text=Hello!%20I%20would%20like%20to%20know%20more%20about%20SASHA%20School%20of%20Life." target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp" className="bg-gradient-to-br from-[#E8F5E9] to-[#F1FFF2] p-7 rounded-[1.5rem] border border-white/50 flex items-start gap-5 group hover:-translate-y-1 transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer block">
            ...
            {/* Phone */}
            <a href="tel:+919750170007" aria-label="Call Us" className="golden-glass-card p-7 rounded-[1.5rem] flex items-start gap-5 group hover:-translate-y-1 transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer block">
            ...
            <div className="bg-gradient-to-br from-[#FCE4EC] to-[#F5F9FF] p-7 rounded-[1.5rem] border border-white/50 flex flex-col gap-4 shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                <a href="https://www.instagram.com/sashaschoolforlife?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#E1306C] shadow-sm hover:scale-110 transition-transform hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] hover:text-white" title="Instagram">
                ...
                <a href="https://www.youtube.com/@sashaschoolforlife" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#FF0000] shadow-sm hover:scale-110 transition-transform hover:bg-[#FF0000] hover:text-white" title="YouTube">
                ...
                <a href="https://www.facebook.com/sashaschoolforlife" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#1877F2] shadow-sm hover:scale-110 transition-transform hover:bg-[#1877F2] hover:text-white" title="Facebook">
                ...
                <a href="https://share.google/FmgJGbqSkDUe6rP79" target="_blank" rel="noopener noreferrer" aria-label="Google Business" className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#34A853] shadow-sm hover:scale-110 transition-transform hover:bg-[#34A853] hover:text-white" title="Google Business">
